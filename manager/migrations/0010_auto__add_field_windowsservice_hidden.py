...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WindowsService.hidden'
        db.add_column(u'manager_windowsservice', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WindowsService.hidden'
        db.delete_column(u'manager_windowsservice', 'hidden')
